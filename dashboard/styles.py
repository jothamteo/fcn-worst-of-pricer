...
def render_what_is_an_fcn() -> None:
    ...
    with st.expander("What is an FCN?", expanded=False):
        st.markdown(
            ...
            "receives approximately *notional / (strike × initial price)* "
            "shares of the worst-performer at the strike price, fractional "
            "shares cash-settled. Cash-equivalent value = "
            "notional × worst-of performance / strike, continuous at the "
            "strike (no cliff).\n"
